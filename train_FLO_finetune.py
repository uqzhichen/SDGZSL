...
parser.add_argument('--dataset', default='FLO', help='dataset: CUB, AWA1, APY, FLO')
...
parser.add_argument('--gh_dim',     type=int, default=512, help='dimention of hidden layer in decoder')
parser.add_argument('--eh_dim',     type=int, default=512, help='dimention of hidden layer in encoder')
...
def train():
    ...
    for it in range(start_step, opt.niter+1):
        ...
        if it % opt.evl_interval == 0 and it >  0:  #5000
            model.eval()
            ae.eval()
