...
parser.add_argument('--gen_nepoch', type=int, default=250, help='number of epochs to train for')
parser.add_argument('--lr', type=float, default=0.00003, help='learning rate to train generater')

parser.add_argument('--ga', type=float, default=0.3, help='relationNet weight')
...
def train():
    ...
    for it in range(start_step, opt.niter+1):
        ...
        if it % opt.evl_interval == 0 and it > 15000: #15000
            model.eval()
            ae.eval()
